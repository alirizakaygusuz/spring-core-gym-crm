...
public class Application {
    ...
    public static void main(String[] args) {
        try (AnnotationConfigApplicationContext context =
            ...
            runTraineeFlow(gymCrmFacade, state);
            runTrainerFlow(gymCrmFacade, state);
            runTrainingFlow(gymCrmFacade, state);

            printAllMaps(gymCrmFacade);
    ...
    private static void runTraineeFlow(GymCrmFacade gymCrmFacade, ScenarioState state) {
        ...
        state.createdTrainee1 = gymCrmFacade.createTraineeProfile(trainee1);
        state.createdTrainee2 = gymCrmFacade.createTraineeProfile(trainee2);
        state.createdTrainee3 = gymCrmFacade.createTraineeProfile(trainee3);
        ...
        System.out.println("Trainee Map Size:" + gymCrmFacade.getAllTraineeProfiles().size());
        ...
        var selectedTraineeById = gymCrmFacade.selectTraineeProfileById(state.createdTrainee1.getId());
        ...
        var selectedTraineeByUsername = gymCrmFacade.selectTraineeProfileByUsername(state.createdTrainee2.getUsername());
        ...
        var updatedTrainee = gymCrmFacade.updateTraineeProfile(state.createdTrainee1.getId(), traineeUpdate);
        System.out.println(" - updated trainee1: " + updatedTrainee);

        // ========Delete Trainee Profile=======
        System.out.println("==========[Trainee] Delete========");

        gymCrmFacade.deleteTraineeProfile(state.createdTrainee3.getId());
        System.out.println(" - deleted trainee3 id=" + state.createdTrainee3.getId());
        System.out.println("Trainee Map Size After Delete:" + gymCrmFacade.getAllTraineeProfiles().size());
    }

    private static void runTrainerFlow(GymCrmFacade gymCrmFacade, ScenarioState state) {
        ...
        state.createdTrainer1 = gymCrmFacade.createTrainerProfile(trainer1);
        state.createdTrainer2 = gymCrmFacade.createTrainerProfile(trainer2);
        state.createdTrainer3 = gymCrmFacade.createTrainerProfile(trainer3);
        ...
        System.out.println("Trainer Map Size:" + gymCrmFacade.getAllTrainerProfiles().size());
        ...
        var selectedTrainerById = gymCrmFacade.selectTrainerProfileById(state.createdTrainer1.getId());
        ...
        var selectedTrainerByUsername = gymCrmFacade.selectTrainerProfileByUsername(state.createdTrainer2.getUsername());
        ...
        var updatedTrainer = gymCrmFacade.updateTrainerProfile(state.createdTrainer1.getId(), trainerUpdate);
        System.out.println(" - updated trainer1: " + updatedTrainer);
    }

    private static void runTrainingFlow(GymCrmFacade gymCrmFacade, ScenarioState state) {
        ...
        state.createdTraining1 = gymCrmFacade.createTrainingProfile(training1);
        state.createdTraining2 = gymCrmFacade.createTrainingProfile(training2);
        state.createdTraining3 = gymCrmFacade.createTrainingProfile(training3);
        ...
        System.out.println("Training Map Size:" + gymCrmFacade.getAllTrainingProfiles().size());

        // ========Select Training Profile=======
        System.out.println("==========[Training] Select========");

        System.out.println("Select By Id: " + state.createdTraining1.getId());
        var selectedTraining = gymCrmFacade.selectTrainingProfile(state.createdTraining1.getId());
        System.out.println(" - Selected Training Profile: " + selectedTraining);
    }

    private static void printAllMaps(GymCrmFacade gymCrmFacade) {
        // ========List ALL (print)=======
